...
export const CATEGORIES = [
  ...
  new Category("c6", "Accessories", "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Accessories/logo.png?raw=true", 4),
];
...
export const PRODUCTS = [
  ...
  new Product(
    ...
    `Description: Soft, breathable jersey Made with organic cotton Grown using less water and no pesticides It’s a win-win
    improving the environment for both cotton farmers and wildlife
  ...
  new Product(
    ...
    399.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Pants/Nike-Tech-Fleece-Joggers-Grey.png?raw=true", //<------- Nike Tech Fleece Joggers img URL
    `Joggers by Nike:
  ...
  new Product(
    ...
    590.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Pants/Levis%20skinny%20jeans%20519.png?raw=true",
  ...
  new Product(
    ...
    590.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Pants/Diesel%20jeans.jpg?raw=true", // <----- Diesel jeans img url
  ...
  new Product(
    ...
    289.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Pants/Adidas%20Joggers.jpg?raw=true", // <----- Adidas joggers img url
    `Joggers by adidas:
  ...
  new Product(
    ...
    669.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Hoodies/Boss%20Hoodie.jpg?raw=true", // <----- Boss Hoodie img url
    `Hoodie by Hugo Boss:
  ...
  new Product(
    ...
    869.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Hoodies/Polo%20Hoodie.jpg?raw=true", // <----- Polo Hoodie img url
  ...
  new Product(
    ...
    869.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Hoodies/Tommy%20Hilfiger%20Hoodie.jpg?raw=true", // <----- Polo Hoodie img url
    `Hoodie by Polo Ralph Lauren:
    - Act casual
    - Drawstring hood
    - Graphic logo print
  ...
  new Product(
    ...
    220.70,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Hoodies/Gant%20Logo%20Hoodie.jpg?raw=true", // <----- Polo Hoodie img url
    `Hoodie by Gant:
  ...
  new Product(
    ...
    719.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Coats/The%20North%20Face%20jacket.png?raw=true", // <----- Polo Hoodie img url
  ...
  new Product(
    ...
    439.90,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Shoes/Adidas%20Stan%20Smith.jpg?raw=true", // <----- Polo Hoodie img url
    `Trainers by adidas:
    - This item is excluded from promo
    - Part of our responsible edit
    - Low-profile design
  ...
  new Product(
    ...
    850.00,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Shoes/hiclipart.com.png?raw=true", // <----- Polo Hoodie img url
    `Trainers by adidas:
    - Hit that new PB
    - Low-profile design 
    - Lace-up fastening
  ...
  new Product(
    ...
    265.00,
    19.90,
    "https://github.com/danielronen/React-Native-/blob/main/Product%20images/Accessories/Boss%20Belt.jpg?raw=true", // <----- Polo Hoodie img url
